...
# dict to use in the for loop to 
measurementDict = {
    0: "L",
    1: "W",
    2: "H"
...
for measurement in houseMeasurements:
    houseMeasurements[x] = int(input("What is the Dimensions of the House {}: ".format(measurementDict[x])))
    x = x + 1
x = 0
for measurement in windowMeasurement:
    windowMeasurement[x] = int(input("What is the Dimensions of the Window {}: ".format(measurementDict[x])))
    x = x + 1
x = 0
for measurement in doorMeasurement:
    doorMeasurement[x] = int(input("What is the Dimensions of the Door {}: ".format(measurementDict[x])))
    x = x + 1
